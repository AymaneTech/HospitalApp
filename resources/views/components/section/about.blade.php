     ...
     <div class="text flex flex-col gap-2 w-[50vw]">
         ...
         <ul class="advices">
             <Li>
                 ...
                 <p>
                     Pellentesque placerat, nisi congue vehicula efficitur.</p>
             </Li>
             <Li>
                 <x-icon name="left-arrow" />
                 <p>Pellentesque placerat, nisi congue vehicula efficitur.</p>
             </Li>
             <Li>
                 <x-icon name="left-arrow" />
                 <p>Phasellus mattis vitae magna in suscipit. Nam tristique posuere sem, mattis molestie est
                     bibendum.
                 </p>
             </Li>
         </ul>
