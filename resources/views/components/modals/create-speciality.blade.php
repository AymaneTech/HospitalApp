...
<div id="Create-speciality" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="create-speciality">
            ...
            <!-- Modal body -->
            <form method="post" action="{{route('speciality.store')}}" enctype="multipart/form-data" class="p-4 md:p-5">
                @csrf
